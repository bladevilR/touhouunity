...
namespace TouhouMigration.Runtime.Data
{
    public static class MigrationSceneRegistry
    {
        private static readonly MigrationSceneOption[] Options =
        {
            ...
            new MigrationSceneOption("magic_forest", "魔法森林", false, MigrationSceneId.BambooHomeVerticalSlice),
            new MigrationSceneOption("misty_lake", "雾之湖", false, MigrationSceneId.BambooHomeVerticalSlice),
            ...
            new MigrationSceneOption("pure_nature_classic", "纯自然·经典", false, MigrationSceneId.BambooHomeVerticalSlice),
            new MigrationSceneOption("pure_nature_fantasy_forest", "纯自然·幻林", false, MigrationSceneId.BambooHomeVerticalSlice),
