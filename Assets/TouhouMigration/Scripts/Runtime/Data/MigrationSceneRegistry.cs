...
namespace TouhouMigration.Runtime.Data
{
    public static class MigrationSceneRegistry
    {
        private static readonly MigrationSceneOption[] Options =
        {
            ...
            new MigrationSceneOption("farm", "农场", true, MigrationSceneId.Farm),
            new MigrationSceneOption("dungeon_entrance", "地牢入口", true, MigrationSceneId.DungeonEntrance),
            ...
            new MigrationSceneOption("hakurei_shrine", "博丽神社", true, MigrationSceneId.HakureiShrine),
            new MigrationSceneOption("scarlet_mansion_front", "红魔馆门前", true, MigrationSceneId.ScarletMansionFront),
